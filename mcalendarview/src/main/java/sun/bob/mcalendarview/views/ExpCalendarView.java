...
//        addBackground();
        ...
        CellConfig.cellHeight = getContext().getResources().getSystem().getDisplayMetrics().widthPixels / 7 / density / 3 * 2;
...
//        this.addOnPageChangeListener(new );
    ...
    public void setData(Map<String,CalendarData.DayDate> calendarData) {
        this.calendarData = calendarData;
        adapter.setCalendarDate(calendarData);
        adapter.notifyDataSetChanged();
    }
}
