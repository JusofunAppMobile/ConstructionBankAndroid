...
package com.qxb.jianhang.ui.view.slidinguppanellayout;
...
public class ViewDragHelper {
    ...
    /**
     *
     * 思路：模拟 settleCapturedViewAt(int finalLeft, int finalTop)方法。
     * 让其动态滚动到某一个位置。
     *
     * @param finalLeft
     * @param finalTop
     * @return
     */
    public boolean settleCapturedViewAtInit(int finalLeft, int finalTop) {
        return forceSettleCapturedViewAt(finalLeft, finalTop, 10000, 10000);
    }
    ...
    public void  setmReleaseInProgress(boolean progress){
        mReleaseInProgress=progress;
    }
