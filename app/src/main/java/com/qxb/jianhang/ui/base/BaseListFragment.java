...
/**
 * @author liuguangdan
 * @version create at 2018/9/18/018 16:15
 * @Email lgd@jusfoun.com
 * @Description ${}
 */
public abstract class BaseListFragment extends BaseBackFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recycler = (XRecyclerView) rootView.findViewById(R.id.recycler);
        adapter = getAdapter();
        if (recycler == null)
